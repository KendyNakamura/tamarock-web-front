    ...
    <>
      <nav className="bg-gray-800 font-mono">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="ml-4 flex items-center md:ml-6">
              ...
              <div className="ml-3 relative">
                ...
                <Transition show={isOpen} enter="transition ease-out duration-100" enterFrom="transform opacity-0 scale-95" enterTo="transform opacity-100 scale-100" leave="transition ease-in duration-75 transform" leaveFrom="transition ease-in duration-75" leaveTo="transform opacity-0 scale-95">
                  {(ref) => (
        ...
        <div className={`${isOpen ? "block" : "hidden"} md:hidden`}>
          ...
          <div className={`${isOpen ? "block" : "hidden"} mt-3 px-2 space-y-1`}>
      ...
      <div className="sFormWrapper">
        <form className="sForm">
          <input type="text" onChange={(e) => setQuery(e.target.value)} value={query} placeholder="アーティスト名を入力" className="sBox" onKeyPress={(e) => handleKeyPress(e)} />
          <Link href={href}>
